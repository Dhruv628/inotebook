  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      {!localStorage.getItem('token')?<form className="d-flex">
        <Link className="btn btn-info mx-1"  type="submit" to='/login' style={{width:'5rem',color:'white'}}>Login</Link>
        <Link className="btn btn-info mx-1"  type="submit" to='/signup' style={{width:'5rem',color:'white'}}>Sign up</Link>
      </form>:null}
